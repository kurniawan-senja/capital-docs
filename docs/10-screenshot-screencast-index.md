...
| --- | --- | --- | --- | --- |
| 1 | Workflow 1 Full Demo | READY trigger to Queue populated | 3-5 min | 2.2 |
| 2 | Workflow 2 Full Demo | Queue READY to Drive upload | 5-8 min | 3.2 |
| 3 | RW Update Demo | Replace RW comp via AE automation | 2-3 min | 4.1 |
| 4 | Error Handling Demo | FAILED path + retry + FATAL alert | 2 min | 7.2 |
